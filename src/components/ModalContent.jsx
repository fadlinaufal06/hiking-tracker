            ...
            <div className="px-6 py-6 lg:px-8">
                ...
                <form className="space-y-6" action="#">
                    ...
                    <div>
                        ...
                        <input type="name" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="John Doe" required></input>
                    </div>

                    <div>
                        <label for="gender" className='pr-4 block mb-2 text-sm font-medium text-gray-900'>Gender</label>
                        <select id="gender" className='shadow'>
                    ...
                    <div>
                        <label for="password" className="block mb-2 text-sm font-medium text-gray-900 ">Age</label>
                        <input name="password" id="password" placeholder="21" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required></input>
                    </div>

                    <div>
                        <h3 for="password" className="block mb-2 text-sm font-medium text-gray-900 ">Add chip id</h3>
                        <input name="password" id="password" placeholder="BAB1EDBD9E7C" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required></input>
                    </div>
